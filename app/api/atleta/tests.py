...
class BaseViewTest(APITestCase):
    ...
    def configuracao(self):
        self.criar_atleta("Gilearde F. Cardoso", "gilearde.f@gmail.com", timezone.now(), 71, 1.65, "SEM DETALHES", "122345678", "SEM CONDICOES", "Futebol", 1, 'A1')
        self.criar_atleta("Bruna J. Zika", "brunazika@gmail.com", timezone.now(),54, 1.62,"SEM DETALHES", "122342671","EM CONDICOES","Futebol", 1, 'A2')
        self.criar_atleta("Fabio Enzo", "enzonfabio@gmail.com", timezone.now(), 65, 1.74, "SEM DETALHES", "622325678", "EM CONDICOES", "Volei", 2, 'A1')
        self.criar_atleta("Katia J. Silva", "katia.jsilva@gmail.com", timezone.now(),67, 1.61,"SEM DETALHES", "222341678","EM CONDICOES","Futebol", 1, 'A2')
        self.criar_atleta("João D. Tobia", "joao.tb@gmail.com", timezone.now(), 82, 1.65, "SEM DETALHES", "1322345678", "SEM CONDICOES", "Volei", 2, 'A1')
